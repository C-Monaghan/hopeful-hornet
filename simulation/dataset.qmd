...
All datasets were generated using the `simulate_data()` function with:

- **Sample size**: n = 10,000
- **Waves**: n_waves = 3
- **Scenarios**: 3 increasingly complex data-generating processes

# Simulation function

The full simulation function is provided below for transparency and
reproducibility.

```{r}
#| label: simulation-function
#| code-fold: true
#| code-summary: "Check out the simulate_data() function"
#| eval: false
...
`simulate_data()` generates longitudinal panel data with multinomial
outcomes under three scenarios:
...
tibble::tribble(
  ~Scenario , ~Description                          ,
          1 , "No Markov Dependence"                ,
          2 , "First-order Markov dependence"       ,
          3 , "Markov dependence with interactions"
) |>
  tinytable::tt() |>
...
<a class="btn btn-success btn-sm" target="_blank" href="data/scenario_1.rds">{{< fa brands r-project >}} &ensp;<span class="font-monospace">Scenario 1.rds</span></a>  &emsp;
<a class="btn btn-success btn-sm" target="_blank" href="data/scenario_2.rds">{{< fa brands r-project >}} &ensp;<span class="font-monospace">Scenario 2.rds</span></a>  &emsp;
<a class="btn btn-success btn-sm" target="_blank" href="data/scenario_3.rds">{{< fa brands r-project >}} &ensp;<span class="font-monospace">Scenario 3.rds</span></a>
